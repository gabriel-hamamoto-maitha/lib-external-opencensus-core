...
const console_logger_1 = require("../src/common/console-logger");
...
describe('ConsoleLogger', () => {
    ...
    describe('new ConsoleLogger()', () => {
        it('should log with default levels', () => {
            logger.logger();
            assert.strictEqual(LEVELS.length, console_logger_1.ConsoleLogger.LEVELS.length);
        });
...
//# sourceMappingURL=test-console-logger.js.map