...
const UNIT = types_2.MeasureUnit.UNIT;
const LABEL_KEYS = [{ key: 'code', description: 'desc' }];
const LABEL_VALUES_200 = [{ value: '200' }];
const LABEL_VALUES_400 = [{ value: '400' }];
...
describe('addInt64Gauge', () => {
    ...
    beforeEach(() => {
        registry = new metric_registry_1.MetricRegistry();
    ...
    it('should return a metric', () => {
        ...
        assert.deepStrictEqual(descriptor, {
            ...
            labelKeys: LABEL_KEYS,
            unit: UNIT,
            type: types_1.MetricDescriptorType.GAUGE_INT64,
        });
...
describe('addDerivedInt64Gauge', () => {
    ...
    it('should return a metric', () => {
        const map = new Map();
        map.set('key', 'value');
        const derivedInt64Gauge = registry.addDerivedInt64Gauge(METRIC_NAME, METRIC_OPTIONS);
...
describe('addDerivedDoubleGauge', () => {
    ...
    it('should return a metric', () => {
        ...
        const derivedDoubleGauge = registry.addDerivedDoubleGauge(METRIC_NAME, METRIC_OPTIONS);
...
describe('addDoubleCumulative', () => {
    ...
    it('should return a metric', () => {
        const int64Gauge = registry.addDoubleCumulative(METRIC_NAME, METRIC_OPTIONS);
        const pointEntry = int64Gauge.getOrCreateTimeSeries(LABEL_VALUES_200);
        pointEntry.inc(1.1);
        const metrics = registry.getMetricProducer().getMetrics();
        assert.strictEqual(metrics.length, 1);
...
describe('addDerivedInt64Cumulative', () => {
    ...
    it('should return a metric', () => {
        const map = new Map();
        map.set('key', 'value');
        const derivedInt64Cumulative = registry.addDerivedInt64Cumulative(METRIC_NAME, METRIC_OPTIONS);
    ...
    it('should return a metric without options', () => {
        const map = new Map();
        map.set('key', 'value');
        const derivedInt64Cumulative = registry.addDerivedInt64Cumulative(METRIC_NAME);
...
describe('addDerivedDoubleCumulative', () => {
    ...
    it('should return a metric', () => {
        ...
        const derivedDoubleCumulative = registry.addDerivedDoubleCumulative(METRIC_NAME, METRIC_OPTIONS);
    ...
    it('should return a metric without options', () => {
        ...
        const derivedDoubleCumulative = registry.addDerivedDoubleCumulative(METRIC_NAME);
...
describe('Add multiple gauges', () => {
    ...
    it('should return metrics', () => {
        ...
        const derivedInt64Gauge = registry.addDerivedInt64Gauge('metric-name3', METRIC_OPTIONS);
        derivedInt64Gauge.createTimeSeries(LABEL_VALUES_400, {
            size: () => arr.length,
        });
        const int64Cumulative = registry.addInt64Cumulative('metric-name4', METRIC_OPTIONS);
        ...
        assert.strictEqual(timeseries1[0].points[0].timestamp.seconds, mockedTime.seconds);
        assert.strictEqual(timeseries1[0].points[0].timestamp.nanos, mockedTime.nanos);
        ...
        assert.deepStrictEqual(timeseries1[0].points[0].timestamp, timeseries2[0].points[0].timestamp);
        assert.deepStrictEqual(timeseries2[0].points[0].timestamp, timeseries3[0].points[0].timestamp);
...
//# sourceMappingURL=test-metric-registry.js.map