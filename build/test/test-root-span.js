...
describe('RootSpan', () => {
    ...
    describe('new RootSpan()', () => {
        it('should create a RootSpan instance', () => {
            ...
            assert.ok(root instanceof root_span_1.RootSpan);
        });
    });
    /**
    ...
    describe('get spans()', () => {
        it('should get span list from rootspan instance', () => {
            const root = new root_span_1.RootSpan(tracer, name, kind, traceId, '');
            root.start();
    ...
    describe('startSpan()', () => {
        let root, span;
        before(() => {
            root = new root_span_1.RootSpan(tracer, name, kind, traceId, parentSpanId);
            root.start();
    ...
    describe('addAtribute()', () => {
        it('should add an attribute', () => {
            ...
            ['String', 'Number', 'Boolean'].map(attType => {
                ...
                assert.strictEqual(rootSpan.attributes['testKey' + attType], 'testValue' + attType);
            });
        });
    });
    /**
    ...
    describe('addAnnotation()', () => {
        it('should add an annotation', () => {
            ...
            function instanceOfAnnotation(object) {
        ...
        it('should add an annotation without attributes and timestamp', () => {
            ...
            assert.strictEqual(rootSpan.annotations[0].description, 'description test');
    ...
    describe('addLink()', () => {
        it('should add a Link', () => {
            ...
            const rootSpan = new root_span_1.RootSpan(tracer, name, kind, traceId, parentSpanId);
            rootSpan.start();
            const span = new span_1.Span(tracer, rootSpan);
            span.start();
            rootSpan.addLink(rootSpan.traceId, span.id, types.LinkType.CHILD_LINKED_SPAN);
    ...
    describe('get traceState()', () => {
        ...
        it('should create a RootSpan instance with traceState', () => {
            const root = new root_span_1.RootSpan(tracer, name, kind, traceId, parentSpanId, 'traceState');
            assert.ok(root instanceof root_span_1.RootSpan);
            assert.strictEqual(root.traceState, 'traceState');
        });
    });
});
//# sourceMappingURL=test-root-span.js.map