...
const derived_cumulative_1 = require("../src/metrics/cumulative/derived-cumulative");
const types_1 = require("../src/metrics/export/types");
const METRIC_NAME = 'metric-name';
const METRIC_DESCRIPTION = 'metric-description';
const UNIT = '1';
const CUMULATIVE_INT64 = types_1.MetricDescriptorType.CUMULATIVE_INT64;
const CUMULATIVE_DOUBLE = types_1.MetricDescriptorType.CUMULATIVE_DOUBLE;
const LABEL_KEYS = [{ key: 'code', description: 'desc' }];
const LABEL_VALUES_200 = [{ value: '200' }];
const LABEL_VALUES_400 = [{ value: '400' }];
const LABEL_VALUES_EXRTA = [{ value: '200' }, { value: '400' }];
...
describe('DerivedCumulative', () => {
    ...
    const startime = { seconds: 1400000100, nanos: 1e7 };
    beforeEach(() => {
        instance = new derived_cumulative_1.DerivedCumulative(METRIC_NAME, METRIC_DESCRIPTION, UNIT, CUMULATIVE_INT64, LABEL_KEYS, EMPTY_CONSTANT_LABELS, startime);
    ...
    describe('createTimeSeries()', () => {
        ...
        it('should return a Metric (Double) - custom object', () => {
            ...
            const queue = new QueueManager();
            const doubleInstance = new derived_cumulative_1.DerivedCumulative(METRIC_NAME, METRIC_DESCRIPTION, UNIT, CUMULATIVE_DOUBLE, LABEL_KEYS, EMPTY_CONSTANT_LABELS, startime);
...
//# sourceMappingURL=test-derived-cumulative.js.map