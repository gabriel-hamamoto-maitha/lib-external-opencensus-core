...
describe('tagger()', () => {
    ...
    const expectedTagsFrom1n3 = new src_1.TagMap();
    ...
    const expectedTagsFrom1n3n4 = new src_1.TagMap();
    ...
    it('should return empty current tag context', () => {
        tagger.withTagContext(contextManager, tagger.EMPTY_TAG_MAP, () => {
            assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), tagger.EMPTY_TAG_MAP);
        });
    });
    it('should set current tag context', () => {
        tagger.withTagContext(contextManager, tags1, () => {
            assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), tags1);
        });
        assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), tagger.EMPTY_TAG_MAP);
    });
    it('should set nested current tag context', () => {
        tagger.withTagContext(contextManager, tags1, () => {
            ...
            tagger.withTagContext(contextManager, tags2, () => {
                assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), expectedMergedTags);
            });
            assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), tags1);
        });
        assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), tagger.EMPTY_TAG_MAP);
    ...
    it('should resolve tag conflicts', () => {
        tagger.withTagContext(contextManager, tags1, () => {
            ...
            tagger.withTagContext(contextManager, tags3, () => {
                assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), expectedTagsFrom1n3);
                tagger.withTagContext(contextManager, tags4, () => {
                    assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), expectedTagsFrom1n3n4);
                });
            });
            assert.deepStrictEqual(tagger.getCurrentTagContext(contextManager), tags1);
        });
...
//# sourceMappingURL=test-tagger.js.map