...
const cumulative_1 = require("../src/metrics/cumulative/cumulative");
...
describe('CUMULATIVE', () => {
    ...
    beforeEach(() => {
        instance = new cumulative_1.Cumulative(METRIC_NAME, METRIC_DESCRIPTION, UNIT, CUMULATIVE_INT64, LABEL_KEYS, EMPTY_CONSTANT_LABELS);
    ...
    describe('getDefaultTimeSeries()', () => {
        ...
        it('should return same timeseries for interchanged labels', () => {
            instance = new cumulative_1.Cumulative(METRIC_NAME, METRIC_DESCRIPTION, UNIT, CUMULATIVE_INT64, [
        ...
        it('should add constant labels', () => {
            instance = new cumulative_1.Cumulative(METRIC_NAME, METRIC_DESCRIPTION, UNIT, CUMULATIVE_DOUBLE, [
                { key: 'k1', description: 'desc' },
                { key: 'k2', description: 'desc' },
            ], CONSTANT_LABELS);
            const point = instance.getOrCreateTimeSeries([
...
//# sourceMappingURL=test-cumulative.js.map