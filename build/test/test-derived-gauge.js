...
const derived_gauge_1 = require("../src/metrics/gauges/derived-gauge");
const METRIC_NAME = 'metric-name';
const METRIC_DESCRIPTION = 'metric-description';
const UNIT = '1';
const GAUGE_INT64 = types_1.MetricDescriptorType.GAUGE_INT64;
const GAUGE_DOUBLE = types_1.MetricDescriptorType.GAUGE_DOUBLE;
...
describe('DerivedGauge', () => {
    ...
    beforeEach(() => {
        instance = new derived_gauge_1.DerivedGauge(METRIC_NAME, METRIC_DESCRIPTION, UNIT, GAUGE_INT64, LABEL_KEYS, EMPTY_CONSTANT_LABELS);
    ...
    describe('createTimeSeries()', () => {
        ...
        it('should return a Metric (Double) - custom object', () => {
            ...
            const obj = new QueueManager();
            const doubleInstance = new derived_gauge_1.DerivedGauge(METRIC_NAME, METRIC_DESCRIPTION, UNIT, GAUGE_DOUBLE, LABEL_KEYS, EMPTY_CONSTANT_LABELS);
        ...
        it('should return a Metric (Double) - custom object', () => {
            ...
            const obj = new QueueManager();
            const doubleInstance = new derived_gauge_1.DerivedGauge(METRIC_NAME, METRIC_DESCRIPTION, UNIT, GAUGE_DOUBLE, LABEL_KEYS, CONSTANT_LABELS);
            doubleInstance.createTimeSeries(LABEL_VALUES_200, obj);
            const metric = doubleInstance.getMetric();
            assert.notStrictEqual(metric, null);
            assert.deepStrictEqual(metric.descriptor, {
...
//# sourceMappingURL=test-derived-gauge.js.map